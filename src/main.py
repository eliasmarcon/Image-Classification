...
def main(args) -> None:
    ...
    ############################## Training ################################
    image_paths, labels = data_source.read_data(size=0.1, augment = args.data_augmentation)
    ...
    ############################## Testing ################################
    test_paths, test_labels = data_source.read_data(base_image_path="./testing_dataset/")
